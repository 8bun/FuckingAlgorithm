...
/**
 * @author cwq
 * @since 2020/4/30 23:49
 * @Description: 有序列表构建前缀和后缀的字典树（后缀以每个字符串的最后一个字符开始），字典树的每个结点存储以到该结点为止的树路径为前缀的字符串下标集合，
 ...
 * @link https://leetcode-cn.com/problems/prefix-and-suffix-search/
 * @限制:
 * @Level:
 */
class TireNode {
