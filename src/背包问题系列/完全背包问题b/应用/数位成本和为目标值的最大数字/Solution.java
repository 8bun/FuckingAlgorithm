package 背包问题系列.完全背包问题b.应用.数位成本和为目标值的最大数字;
...
/**
 * @author cwq
 * @since 2020/5/17 10:13
 * @Description: 完全背包的刚好装满问题
 * @link https://leetcode-cn.com/contest/biweekly-contest-26/problems/form-largest-integer-with-digits-that-add-up-to-target/
 * @限制: cost.length == 9
 * 1 <= cost[i] <= 5000
 * 1 <= target <= 5000
 * @Level:
